...
def input_data():
    ...
    metadata = {
        ...
        'Contributor': ["Michael Tremmel", "Jaelyn Roth"],
        'Email': ["mtremmel@ucc.ie", "jaelyn.roth@vanderbilt.edu"],
        'Principal': ["Michael Tremmel"],
        'Reference': ["10.1093/mnras/stx1160"],
        # OPTIONAL:
        ...
        # REQUIRED
        'HubbleConstant': 67, #km s^-1 Mpc^-1
        'OmegaMatter': 0.3086,
        'OmegaLambda': 0.6914,
        'BoxSize': 25, # cMpc h^-1 (comoving)
        'MinBHSeedMass': 1e6, #M_sun
        'MinRedshift': 0,
        'MaxRedshift': 20,
        'StellarMassResolution': 6e4, # M_sun
        'DarkMatterMassResolution': 3.4e5, # M_sun
        'SpatialResolution': 350, # pc h^-1 (comoving)
        # OPTIONAL:
        'MinimumDarkMatterHaloMass': 1e7, # M_sun
        'GasMassResolution': 2.1e5, # M_sun
    }
    #*********************************************************#
    #*********************************************************#
...
def get_binary_information(metadata):
    ...
    m1 = bhmergers['merge_mass_1'] # Msun
